export const HERO_IMAGE = "https://cdn.poehali.dev/projects/3345e4d2-6a9b-485a-9bd1-384ca648e1e9/files/543d7606-0cf8-4aec-88e3-aab3f77274a1.jpg";
...
export const CATEGORIES = ["Все", "Спреды", "Масло", "Сыры", "Топлёные смеси", "Топлёное масло"];
...
export const DOCS = [
  { name: "Прайс-лист",       desc: "Актуальные цены на все позиции",  icon: "FileText",  emoji: "📋", bg: '#f0a500' },
  { name: "Договор поставки", desc: "Типовой договор для партнёров",   icon: "FileCheck", emoji: "📝", bg: '#4caf32' },
  { name: "Реквизиты",        desc: "Банковские и юридические данные", icon: "Building2", emoji: "🏦", bg: '#d4780a' },
];
